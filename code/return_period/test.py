...
def load_catchment_outer_boundaries(catchments: list[dict], crs_if_missing: str = "EPSG:4326") -> list[dict]:
    """Load catchments and return dissolved (outer) geometries in EPSG:4326."""
    out = []
    for c in catchments:
        ...
        union_geom = gdf.geometry.union_all()  # removes internal borders
...
if __name__ == "__main__":
    ...
    pdf_out = (
        f"{path_out}xy_returnperiod_annual_{variable}_era5_{grid}_{x_days}dayacc_{grid}_"
