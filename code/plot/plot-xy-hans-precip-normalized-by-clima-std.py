...
- Focus on southern Norway
- Uses pcolormesh
- Catchment border overlay in red (TWO catchments from GeoJSON)
"""
...
def plot_all_panels(da_hans, da_std, catchment_geoms=None, *, figpath=None):
...
if __name__ == "__main__":
    ...
    if write2file:
        figpath = f"{path_in_clim}hans_3panel_tp24_{x_days}dayacc_{grid}_{hans_date}_2catchments.png"
    else:
        figpath = None

    plot_all_panels(da_hans, da_std, catchment_geoms=catchments, figpath=figpath)
    plt.show()
