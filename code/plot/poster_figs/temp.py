...
Figure 1: Storm Hans precipitation and pressure maps.
...
def make_figure_axes():
    """Create four map panels and one shared colorbar."""
...
def main():
    ...
    try:
        ...
        finalize_layout_and_save(fig=fig, savepath=OUTPUT_FILE)
