...
ds_senorge = xr.open_dataset(filename1).sel(time=slice('2023-08-02','2023-08-11'))
ds_era5_ro = xr.open_dataset(filename2).sel(time=slice('2023-08-02','2023-08-11'))
ds_era5_sro = xr.open_dataset(filename3).sel(time=slice('2023-08-02','2023-08-11'))
ds_era5_land_sro = xr.open_dataset(filename4).sel(time=slice('2023-08-02','2023-08-11'))


#plt.plot(ds_era5_land_sro['sro'],'g', label = 'era5_land sro')
#plt.plot(ds_senorge['gwb_q'],'r',label = 'senorge gwb_q')
