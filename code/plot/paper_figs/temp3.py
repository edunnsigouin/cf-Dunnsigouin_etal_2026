...
grouping = "all"      # "all" or "valid_month"

first_input_lead = 16
last_input_lead = 46

first_valid_accumulation_lead = (
    first_input_lead + x_days - 1
)

# Construct the input filename so that it matches the calculation script.
filename_in = (
...
filename_stem = (
    f"independence_spearman_combined_{variable}_"
    f"{x_days}dayacc_{catchment}"
)
