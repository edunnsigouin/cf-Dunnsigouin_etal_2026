...
Each full or split lead-time sample is assigned independently to the calendar
month containing the majority of valid accumulated lead dates within that
range. Thus, split samples do not inherit the calendar-month assignment of the
full lead-time window.
